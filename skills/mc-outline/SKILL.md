...
3. Write ONE outline (not options): tight beat list from hook to payoff. Every beat cites the braindump passage that fills it. Order for retention: strongest material early, open loops closed late, no throat-clearing beat at the top.
4. Write the packaging promise: the working title and thumbnail concept this video must pay off. If the video cannot pay off a clickable promise, say so now; that is a project problem, not a packaging problem.
...
- Exactly 3 hooks, one outline, one packaging promise.
