---
name: mc-graphics
description: Execute the approved beat table in HyperFrames/OGraf/HTML, render, frame-verify, and deliver alpha overlays plus a HANDOFF for the creator's editor. Use at the graphics stage, only after gate 3 (beats) is approved.
---
