...
Talking-head profile adapted for course/lesson content. The first five lessons are training data: this file accumulates a lesson-design philosophy as they ship, and only then does the format stabilize.

## Style philosophy (seed; expect heavy revision)
...
- None yet. Definition card and checkpoint slide should be the first two templates built.
